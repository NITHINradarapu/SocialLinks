      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            <div className="w-24 h-24 rounded-2xl mb-6 flex items-center justify-center p-1" style={{ background: 'linear-gradient(135deg, var(--accent), var(--accent-dim)) shadow-lg' }}>
            ...
            <p className="text-[var(--text-secondary)] font-medium">Developer & Creator</p>
          </div>

          <div className="space-y-8">
            <section>
              <h2 className="text-xs font-bold uppercase tracking-widest mb-4 flex items-center gap-2" style={{ color: 'var(--accent-bright)' }}>
                <span className="w-6 h-px bg-[var(--accent-glow)]"></span>
                About Me
              </h2>
              <p className="text-[var(--text-secondary)] leading-relaxed text-[15px]">
                I'm Nithin Radarapu, a passionate developer focused on building modern, 
                user-centric digital experiences. LinkHub is a project born out of the need 
                for a clean, fast, and customizable way to share all your important links in one place.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-[11px] font-bold text-[var(--text-tertiary)] uppercase tracking-wider">Email</div>
                    <div className="text-[14px] font-semibold text-[var(--text-primary)]">contact@nithin.dev</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <div className="text-[11px] font-bold text-[var(--text-tertiary)] uppercase tracking-wider">GitHub</div>
                    <div className="text-[14px] font-semibold text-[var(--text-primary)]">github.com/NITHINradarapu</div>
                  </div>
                </a>
              </div>
            </section>
